<?php
  //le model de la table questions.
  class Questions extends Model{
    ...
    public function addquest($data){
      ...
      $this->db->preRequest('INSERT INTO questions (question, quiz) VALUES(:question, :quiz)');
      
      //association des valeurs
      $this->db->bindvalue(':question', $data['question']);
      $this->db->bindvalue(':quiz', $data['quiz']);
    ...
    //list question
    public function listeQuestion($idquiz){

      //préparation de la requete
      $this->db->preRequest('SELECT * FROM questions WHERE quiz = '.$idquiz);
    ...
    //suppremer un question
    public function deleteQuest($id){

      //préparation de la requete
      $this->db->preRequest('DELETE FROM questions WHERE id = :id');
