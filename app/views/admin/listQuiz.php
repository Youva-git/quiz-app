...
<div class="container ">
  ...
  <h2 class="text-center mb-10"> <?php  echo 'La Liste Des Quiz '.'</n>'; ?></h2>
  <!-- le message d'erreur-->
...
<?php  if(!empty($rowsTable)){ 
    ...
    <tbody>
     ...
     <?php
      ...
      <tr > 
          ...
          <td>
            <form action="<?php echo Router::url('admin/deletequiz');?>" method="post">
 ...
 <?php  }else{
    ?>
  <h6 class="text-center mb-10"> <?php   echo 'La liste est Vide'.'</n>'; ?></h6>
  <?php }?>
